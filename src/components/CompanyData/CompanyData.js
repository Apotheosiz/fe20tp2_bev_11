import { AreaChart, Area, LineChart, Line, BarChart, Bar, ReferenceLine, Scatter, CartesianGrid, XAxis, YAxis, Tooltip, Legend, ResponsiveContainer } from 'recharts';
            ...
            fetch(`https://api.polygon.io/v2/aggs/ticker/TSLA/range/${optionsState}/${timeInterval}?unadjusted=true&sort=asc&limit=5000&apiKey=skUrtuzSI4Dp7Zd6NOK8rEdIrxXHlq7Y`)
              ...
              .then(data2 => {
                if (data2.status === "OK" && data2.results) {
                  ...
                  setStockData(merge(arr, arr2, "time"));
                  // setMaxPrice(max);
                  // setMinPrice(min);
          ...
          <div>
            ...
            <ResponsiveContainer width="100%" height={300} >
              ...
              <AreaChart width={600} height={300} data={stockData} margin={{ top: 5, right: 20, bottom: 20, left: 3 }}>
                ...
                {compareMode ?
                  <>
                    <Area type="linear" stackId="1" dataKey="price" stroke="var(--textColor)" name={comp.currency} dot={false} fill="url(#graphGradient)" strokeWidth={2} />
                    <Area type="linear" stackId="1" dataKey="price2" stroke="red" name={comp.currency} dot={false} fill="yellow" strokeWidth={2} />
                  </>
                  :
